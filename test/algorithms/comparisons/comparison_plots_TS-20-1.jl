a = load("test/algorithms/comparisons/data/TS-20-1-comparisons.jld2")
at = a["at"]
...
ps = ATPlottingStruct(
 size(at.at_in.tvals[ps_tval_indices],1),
...
# Approximations
      nt = size(at.at_in.tvals[ps_tval_indices],1)
      data = zeros(nt, 3)
      ...
      data[:,3] = at.lpoa.dist.approx_tvs.mb.SDP[ps_tval_indices]

      p = groupedbar(at.at_in.tvals[ps_tval_indices], 
        log10.(data),
...
# TV Bounds
  ...
  rta_min_bound = min.(at.rta.dist.tv_bound_uppers.mb.SDP[ps_tval_indices],
                      at.rta.dist.tv_bound_lowers.mb.SDP[ps_tval_indices])
...
# Equilibrium Expectation Bound Plots 
  ...
  data[:,2] = log10.((rta_lin_out.ubs.mb.SDP[ps_tval_indices]-rta_lin_out.lbs.mb.SDP[ps_tval_indices])/nrm)
  data[:,3] = log10.((lpoa_lin_out.ubs.mb.SDP[ps_tval_indices]-lpoa_lin_out.lbs.mb.SDP[ps_tval_indices])/nrm)
